                ...
                <div className="pt-[8px] text-[22px] font-medium text-darkBlue">
                    <div className='flex items-center justify-between mb-[16px]'>
                        <div className='gap-2 flex items-center'>
                            <span className='w-[28px] h-[28px] flex items-center justify-center rounded-full'><img src={DocumentUploadBg} /></span>
                    ...
                    <div className="flex flex-col items-center justify-center p-[18px] text-[14px] text-center text-gray1 border-2 border-dashed border-gray min-h-[228px] rounded-[6px] mb-[20px]">
                        <FileUpload setIsViewPrompts={setIsViewPrompts} chatData={chatData} setChatData={setChatData} selectedFile={selectedFile} setSelectedFile={setSelectedFile} setIsUploadDocument={setIsUploadDocument} />
                    </div>
                    <button
