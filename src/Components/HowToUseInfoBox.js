...
const HowToUseInfoBox = ({ setIsAudioInfoPopup }) => {
    ...
    return (
        <div
            ...
            // show={open}
        >
            <div className="pt-[8px] pb-[8px] mb-[20px] text-[22px] font-medium text-darkBlue">
            ...
            <div className="">
                <div className="bg-lightblue1 px-[15px] py-[11px] text-gray1 mb-[16px]">
                    Voice input requires microphone access, and only supports Chrome for now.
                </div>
                <div className="mb-[16px] flex flex-col gap-[4px]">
                    <div className="text-[14px] font-medium text-darkBlue">
                        Start recording:
                    </div>
                    <div className="text-[14px] text-gray1">
                        Click the button or hold
                        <span className="font-medium text-primaryBlue border border-primaryBlue rounded-[4px] py-[1px] px-[3px] mx-[3px]">Space</span>
                        to start recording.
                    </div>
                ...
                <div className="mb-[16px] flex flex-col gap-[4px]">
                    ...
                    <div className="text-[14px] text-gray1">
                        ...
                        <span className="font-medium text-primaryBlue border border-primaryBlue rounded-[4px] py-[1px] px-[3px] mx-[3px]">Esc</span>
                        to cancel recording.
                    </div>
                </div>
                <div className="mb-[16px] flex flex-col gap-[4px]">
                    ...
                    <div className="text-[14px] text-gray1">
                        ...
                        <span className="font-medium text-primaryBlue border border-primaryBlue rounded-[4px] py-[1px] px-[3px] mx-[3px]">E</span>
