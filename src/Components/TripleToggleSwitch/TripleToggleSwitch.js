...
import "../TripleToggleSwitch/style.css";
  ...
  render() {
    ...
    return (
      <div className="main-container">
        ...
        />
        <label
          className={`text-darkgray1 left-label ${
            this.state.switchPosition === "left" && "text-black"
          }`}
          htmlFor="left"
        >
          <h4 className="font-medium">{labels.left.title}</h4>
        </label>
        ...
        />
        <label
          className={`text-darkgray1 center-label ${
            this.state.switchPosition === "center" && "text-black"
          }`}
          htmlFor="center"
        >
          <h4 className="font-medium">{labels.center.title}</h4>
        </label>
        ...
        />
        <label
          className={`text-darkgray1 right-label ${
            this.state.switchPosition === "right" && "text-black"
          }`}
          htmlFor="right"
        >
          <h4 className="font-medium">{labels.right.title}</h4>
        </label>
      </div>
    );
  }
