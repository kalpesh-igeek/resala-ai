                            ...
                            <>
                                <div className="pt-[8px] pb-[20px] text-[22px] font-medium text-darkBlue">
                                    ...
                                    <div className='flex items-center justify-between'>
                                        <div className='gap-2 flex items-center text-[16px]'>
                                            <span className='text-darkblue'>Total: </span>
                                        </div>
                                        <div className="flex text-primaryBlue items-center">
                                            <span className="text-[14px] font-medium -mt-[10px]">
                                                $
                                            </span>
                                            <span className="text-[24px] font-medium">
                                                {selectedPlan.planPrice}
                                            </span>
                                            <span className="text-[14px] font-medium -mb-[10px]">
                                ...
                                <div className="flex flex-col justify-center">
                                    ...
                                    <div className="flex items-center mb-[24px]">
                                        ...
                                        <label
                                            htmlFor='savecard'
                                            className="ml-3 min-w-0 flex-1 text-[14px] text-gray1"
                                        >
