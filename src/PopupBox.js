...
export default function PopupBox({ SELECTION, handleSidebar, selectedText, positionX, positionY }) {
        ...
        >
          <div className="menu-inner">
            ...
            <div className="boxMenu">
              {pinnedItems.map((pin, index) => (
                <div
                  className="py-1 font-dmsans text-xs flex justify-between items-center gap-2 selectText"
                  key={index}
                >
                  <div
                    className="flex justify-center items-center gap-2 cursor-pointer"
              ...
              <div className="py-1 font-dmsans text-xs flex items-center gap-2 cursor-pointer">
