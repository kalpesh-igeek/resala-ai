    ...
    return (
        <>
            ...
            <div className="py-[12px] px-[20px]">
                <label for="input" className="block text-[10px] font-bold leading-6 text-gray1 uppercase">Current Plan</label>
            ...
            {selectedCard &&
                <div className="py-[12px] px-[20px]">
                    <div className="flex justify-between">
                        <label for="input" className="text-[10px] font-bold leading-6 text-gray1 uppercase">Payment method</label>
                        <button
            ...
            <div className="py-[12px] px-[20px]">
                <div className="mb-[16px]">
                    <label for="input" className="block text-[10px] font-bold leading-6 text-gray1 uppercase mb-[10px]">Reisala.ai Pro plan</label>
                ...
                {plans.map((item) =>
                    <PlanInfo selectedCard={selectedCard} setAddCard={setAddCard} setSelectedPlan={setSelectedPlan} setIsPaymentPopupBox={setIsPaymentPopupBox} item={item} />
                )}
            </div>
            <BuyPlan
                cardList={cardList}
