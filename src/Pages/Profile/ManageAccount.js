        ...
        <>
            {deleted ?
                ...
                <>
                    <Header>
                        ...
                        <div className="flex flex-col justify-center p-[20px]">
                            ...
                            <div className="relative">
                                ...
                                />
                                <div className="absolute right-[20px] top-[15px] text-primaryBlue text-[14px] cursor-pointer" onClick={() => handleEditField(NAME_TYPE)}>Edit</div>
                            </div>
                            <div className="relative">
                                <InputField
                                ...
                                />
                                <div className="absolute right-[20px] top-[15px] text-primaryBlue text-[14px] cursor-pointer" onClick={() => handleEditField(PASSWORD_TYPE)}>Edit</div>
                            </div>
                    ...
                    <ModificationPopup isModificationBox={isModificationBox} setIsModificationBox={setIsModificationBox} setLoggedUser={setLoggedUser} editModalType={editModalType} />
                    <DeleteAccountPopup deleted={deleted} setDeleted={setDeleted} setIfOpenDeleteBox={setIfOpenDeleteBox} ifOpenDeleteBox={ifOpenDeleteBox} />
                </>
            }
        </>
    );
