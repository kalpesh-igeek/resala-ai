        ...
        <>
            <div className="flex justify-between items-center gap-2">
                <div className="w-full">
                    <div className="w-full text-[16px] text-darkblue font-medium mb-[5px]">Quick Reply</div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className={`cursor-pointer ${dropDown ? "rotate-180" : "rotate-0"}`} onClick={handleToggle}>
                        <img className="w-[40px]" src={ArrowDown} />
                    </div>
                </div>
            </div>
            <div className={`${dropDown ? "block" : "hidden"}`}>
                <label for="actions" className="block text-[10px] font-medium leading-6 text-gray1 mt-[15px]">TONE</label>
                ...
                <label for="actions" className="block text-[10px] font-bold leading-6 text-gray1 uppercase mt-[15px]">Language</label>
