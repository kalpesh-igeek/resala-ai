        ...
        <>
            <div className="flex justify-between items-center gap-2">
                <div className="w-full">
                    <div className="w-full text-[16px] text-darkblue font-medium mb-[5px]">Pause Extension</div>
                ...
                <div className="flex items-center gap-2">
                    <div className="cursor-pointer" onClick={handleOpenAddNewSite}>
                        <img className="w-[40px]" src={AddCircle} />
                    </div>
                    <div className={`cursor-pointer ${dropDown ? "rotate-180" : "rotate-0"}`} onClick={handleToggle}>
                        <img className="w-[24px]" src={ArrowDown} />
                    </div>
                </div>
            </div>
            <div className={`${dropDown ? "block" : "hidden"}`}>
                    ...
                    {selectedSites.map((site, index) =>
                        <div className="w-full justify-between flex items-center gap-2 mb-[20px]">
                            <div className="flex gap-2 items-center">
                                ...
                                <div>
                                    <div className="w-full text-[10px] text-darkblue font-medium mb-[3px] text-ellipsis overflow-hidden whitespace-nowrap w-[260px]">{site.name}</div>
                                    <div className="text-[8px] text-darkgray1 text-ellipsis overflow-hidden whitespace-nowrap w-[365px]">{site.url}</div>
                                </div>
                            </div>
                    ...
                    {currentSite &&
                        <div className="w-full flex justify-between items-center gap-2 mb-[20px]">
                            <div className="flex gap-2 items-center">
                                ...
                                <div>
                                    <div className="w-full text-[10px] text-darkblue font-medium mb-[3px] text-ellipsis overflow-hidden whitespace-nowrap w-[260px]">{currentSite.name} <span className="rounded-[2px] px-[6px] py-[3px] bg-green text-white">Current Tab</span></div>
                                    <div className="text-[8px] text-darkgray1 text-ellipsis overflow-hidden whitespace-nowrap w-[365px]">{currentSite.url}</div>
                                </div>
                            </div>
                ...
                <div className="mt-[20px]">
                    {addNewSite ?
                        <>
                            <label for="input" className="block text-[10px] font-medium leading-6 text-darkBlue">Add new</label>
                            <div className="flex items-center gap-2">
                                <div className="w-full">
                                    <input
                                        id="addwebsite"
