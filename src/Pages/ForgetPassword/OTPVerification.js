      ...
      {isOTPSent ? (
        ...
        <>
          ...
          <InputField
            ...
            placeholder="000 000"
          />
          <button className="bg-transparent text-primaryBlue w-full rounded-md px-1 py-[5px] text-[14px] font-medium hover:opacity-90 disabled:cursor-none disabled:opacity-50">
            Resend code
          </button>
          <button
